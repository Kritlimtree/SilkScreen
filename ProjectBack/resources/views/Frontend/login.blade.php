				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Header -->
								<header id="header">
									<!-- <a href="register.html" class="logo"><strong>ยินดีต้อนรับ</strong> by HTML5 UP</a> -->
							...
							<!-- Menu -->
								<!-- <nav id="menu">
									...
									<ul>
										...
										<li><a href="generic.html">การสั่งสกรีนเสื้อผ้า</a></li>
										<li><a href="elements.html">ตรวจสอบสินค้า</a></li> -->
										<!-- <li>
