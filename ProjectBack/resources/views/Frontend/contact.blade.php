							...
							<!-- Header -->
								<header id="header">
									...
									<ul class="icons">
										...
										<li><input type="button" onclick="history.back()" value="ย้อนกลับ"></li>
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										...
										<header>
											<div class="align-center"><h2>ติดต่อเรา</h2></div>
											...
											<!-- <p>A free and fully responsive site template</p> -->
												...
												<div class="features">
													...
													<label for="fname">เรื่องที่ต้องการจะติดต่อ:</label>
													<div class="col-12">
										  ...
										  <ul class="actions2">
											...
											<li><a href="#" class="button secondary">ส่งเรื่องต้องการที่จะติดต่อ</a></li>
										</ul>
