						...
						<div class="inner">
							...
							<!-- Section -->
								<section>
									...
									<form class="box" method="post" action="{{route('edit_user_store')}}" enctype="multipart/form-data">
										@csrf
											<label for="fname">email:</label>
											<input type="text" id="email" name="email" placeholder="กรอก email" value="<?php echo $user[0]->user_email ?>"><br>
											@if ($errors->has('email'))
											...
											<input type="text" id="name" name="name" placeholder="กรอกชื่อจริง" value="<?php echo $user[0]->user_name ?>"><br>
											@if ($errors->has('name'))
												<div class="alert alert-danger">
													<ul>
											...
											<input type="text" id="fname" name="fname" placeholder="กรอกนามสกุล" value="<?php  echo $user[0]->user_fname ?>"><br>
											@if ($errors->has('fname'))
												<div class="alert alert-danger">
													<ul>
											...
											<div class="col-6">
											<input type="text" id="address" name="address" placeholder="กรอกที่อยู่" value="<?php echo $user[0]->user_address ?>"></input>
											...
											<div class="col-6" style="padding-top: 5px;">
													<select name="province" id="province" class="province">
														<option value="<?php echo $user[0]->id ?>" selected><?php echo $user[0]->province_name_th ?></option>
												...
												<div class="col-6" style="padding-top: 5px;">
													<select  name="amphures" id="amphures"  class="amphures">
														<option value="<?php echo $user[0]->amphure_id ?>" selected><?php echo $user[0]->amphure_name_th ?></option>
													</select>
											...
											<div class="row gtr-25">
												...
												<div class="col-6" style="padding-top: 5px;">
													<select  name="district" id="district" class="district">
														<option value="<?php echo $user[0]->id_tumbon ?>" selected><?php echo $user[0]->district_name_th ?></option>
												...
												<div class="col-6" style="padding-top: 5px;">
													<select  name="postcode" id="postcode" class="postcode">
														<option value="<?php echo $user[0]->zip_code ?>" selected><?php echo $user[0]->zip_code ?></option>
											...
											<input type="tel" id="phone" name="phone" placeholder="กรอกเบอร์โทร" value="<?php echo $user[0]->user_phone ?>"><br>
											@if ($errors->has('phone'))
												<div class="alert alert-danger">
													<ul>
