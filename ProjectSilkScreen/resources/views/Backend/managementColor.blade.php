			...
			<div id="wrapper">
                ...
                <!-- Create Modal -->
									...
									<div class="modal-dialog">
										...
										<form action="{{ route('managementColor_store') }}" method="POST" enctype="multipart/form-data">
										@csrf
                   ...
                   <!-- edit Modal -->
									...
									<div class="modal-dialog">
										...
										<form action="{{ route('managementColor_update') }}" method="POST" enctype="multipart/form-data">
										@csrf
										@method('PUT')
											<label for="size">สี:</label>
                  ...
                  <!-- Delete Modal -->
									...
									<div class="modal-dialog">
										...
										<form action="{{route('managementColor_delete')}}" method="POST"  >
											@csrf
											@method('DELETE')
										<div class="modal-body">
											
											<p>Are You Sure ?</p>
											<input type="hidden" id="delete_id" name="id_color" value="DELETE">
										</div>
										<div class="footer">
                    <button type="button" class=" danger" data-bs-dismiss="modal">Close</button>
										<button type="submit" class="secondary" data-loading-text="Loading...">
        ...
        // Edit
				$(document).on('click','.editbtn',function (){
					...
					$.ajax({
						...
						method: "GET", 
						url: "/managementColor-edit/"+id,
						
						success: function (response){	
               
							 $('#edit_id').val(id);
							 $('#color_name_edit').val(response.color[0].color_name);
							 $('#color_code_edit').val(response.color[0].color_code);
